...
Command: npx gltfjsx@6.2.12 ./public/models/cars/lambo/scene.gltf 
...
export default function Lambo(props) {
  const { nodes, materials } = useGLTF("/models/cars/lambo/scene.gltf");
  return (
...
useGLTF.preload("/models/cars/lambo/scene.gltf");
